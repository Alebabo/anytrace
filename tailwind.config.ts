  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        signal: {
          twitter: "hsl(var(--signal-twitter))",
          linkedin: "hsl(var(--signal-linkedin))",
          github: "hsl(var(--signal-github))",
        },
        tier: {
          angel: "hsl(var(--tier-angel))",
          "angel-soft": "hsl(var(--tier-angel-soft))",
          microvc: "hsl(var(--tier-microvc))",
          "microvc-soft": "hsl(var(--tier-microvc-soft))",
          vc: "hsl(var(--tier-vc))",
        },
