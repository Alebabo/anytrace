...
import traqrLogo from "@/assets/traqr-logo.svg";
import { AccessBadge } from "@/components/traqr/AccessBadge";
...
const nav: NavItem[] = [
  ...
  { to: "/agent-swarm", label: "Agent Swarm", icon: Orbit },
        ...
        <header className="sticky top-0 z-20 flex h-14 items-center gap-2 border-b border-border bg-background px-3 md:h-16 md:gap-4 md:px-8">
          <Sheet open={mobileNavOpen} onOpenChange={setMobileNavOpen}>
            ...
            <SheetContent side="left" className="flex w-64 flex-col bg-sidebar p-0">
              <Link to="/" className="flex h-20 items-center justify-center px-4" aria-label="traqr.ai">
                <img
                  src={traqrLogo}
                  alt="traqr.ai"
