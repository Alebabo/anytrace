...
with new_seed_data (slug, name, country, size_label, sector_focus, twitter_url, linkedin_url) as (
  values
    ('atomico', 'Atomico', 'Vereinigtes Koenigreich', 'gross', 'General Tech, Software, Deep Tech', 'https://twitter.com/nzennstrom', 'https://www.linkedin.com/company/atomico/'),
    ('index-ventures', 'Index Ventures', 'UK/Europa', 'gross', 'Software, Consumer, Fintech, SaaS', 'https://twitter.com/indexventures', 'https://www.linkedin.com/company/index-ventures/'),
